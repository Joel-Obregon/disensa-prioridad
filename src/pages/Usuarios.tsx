      ...
      >
        ...
        <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-6">
          ...
          <Campo
            ...
            onChange={(correo) => setFormulario({ ...formulario, correo })}
          />
          <Campo
            label="Contrasena"
            type="password"
  ...
  return (
    <label className="text-sm font-medium text-slate-700">
      ...
      <input
        ...
        className="mt-1 w-full rounded-lg border border-slate-300 px-4 py-2 outline-none focus:ring-2 focus:ring-orange-500 disabled:bg-slate-100 disabled:text-slate-400"
      />
    </label>
  )
}
