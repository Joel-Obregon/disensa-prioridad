...
create table if not exists public.material_catalogo (
  ...
  numero_fb text,
  codigo_nuestro_material text,
  codigo_fabricante_nuestro text,
  codigo_suministrador text,
  nombre_suministrador text,
  marca_material text,
  catman_nombre text,
  catman_nuestro text,
  catman_categoria text,
  unidad_medida_base text,
  estado_planificacion text,
  min_venta numeric(14, 3) not null default 1,
  mult_venta numeric(14, 3) not null default 1,
  min_compra numeric(14, 3) not null default 1,
  mult_compra numeric(14, 3) not null default 1,
